...
<<<<<<< HEAD
	public static int idDetalleCompraSeleccionada, idProductoSeleccionado = -1;
	...
	public void cargarTablaCompras(String filtro) {
		...
		String[] columnas = {"ID Detalle Compra", "ID Compra", "Producto", "Descripción", "Cantidad", "Precio Unitario", "Total Producto"};
	...
	public void cargarTablaProductos(String filtro) {
		...
		String[] columnNames = {"ID Producto", "Nombre", "Descripción", "Precio Unitario", "Stock", "Categoría", "Código de Barras"};
