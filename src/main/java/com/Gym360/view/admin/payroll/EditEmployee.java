...
public class EditEmployee extends javax.swing.JFrame {
        ...
        public EditEmployee() {
                ...
                cargarDatosEmpleado(PayrollManagementScreen.idEmpleadoSeleccionado);

                btnEditarEmpleado.setEnabled(datosValidos());
                mostrarErrores();
        }
        ...
        private void initComponents() {
                ...
                lbCrearUsuario.setText("EDITAR EMPLEADO");
                ...
                imgEditarEmpleado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/resources/images/editar.png"))); // NOI18N
                panelEditarEmpleado.add(imgEditarEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 660, 40, 60));

                btnEditarEmpleado.setBackground(new java.awt.Color(93, 0, 0));
                btnEditarEmpleado.setFont(new java.awt.Font("Inter", 1, 18)); // NOI18N
                ...
                panelEditarEmpleado.add(btnEditarEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 660, 300, 60));
        ...
        private void actualizarEmpleado() {
                ...
                try {
                        ...
                        if (resultado) {
                                JOptionPane.showMessageDialog(this, "El empleado se actualizó correctamente.",
                                ...
                                JOptionPane.showMessageDialog(this, "No se pudo actualizar el empleado.", "Error",
                                                JOptionPane.ERROR_MESSAGE);
                        }

                } catch (Exception e) {
                        JOptionPane.showMessageDialog(this,
                                        "Ocurrió un error al actualizar el empleado: " + e.getMessage(), "Error",
                                        JOptionPane.ERROR_MESSAGE);
                }
        }

        public void cargarDatosEmpleado(int idEmpleado) {
                // Crear una instancia del DAO para obtener el empleado por su ID
                EmpleadoDAO empleadoDAO = new EmpleadoDAO();
                Empleado empleado = empleadoDAO.obtenerPorId(idEmpleado);

                // Si el empleado existe, cargar los datos en los campos
                if (empleado != null) {
                        CambiarIU.ponerTextoCampo(tfNombre, empleado.getNombre());
                        CambiarIU.ponerTextoCampo(tfApellido, empleado.getApellido());
                        CambiarIU.ponerTextoCampo(tfSalario, String.valueOf(empleado.getSalario()));
                        CambiarIU.ponerTextoCampo(tfFechaContrato, empleado.getFechaContratacion());
                        CambiarIU.ponerSeleccionCombo(cbCargo, empleado.getCargo());
                        CambiarIU.ponerTextoCampo(tfTelefono, empleado.getTelefono());
                        CambiarIU.ponerTextoCampo(tfCorreo, empleado.getEmail());
                        CambiarIU.ponerTextoCampo(tfIdentificacion, String.valueOf(empleado.getIdEmpleado()));
                } else {
                        System.out.println("Empleado no encontrado.");
                        JOptionPane.showMessageDialog(this, "No se encontró el empleado con ID: " + idEmpleado, "Error",
                                        JOptionPane.ERROR_MESSAGE);
                }
        }
        ...
        private boolean datosValidos() {
                return Verificar.validarNombre(ObtenerIU.obtenerTextoCampo(tfNombre))
                                ...
                                && Verificar.validarYVerificarCedulaSeleccionada(
                                                ...
                                                PayrollManagementScreen.idEmpleadoSeleccionado)
