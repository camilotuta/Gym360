...
import main.java.com.Gym360.util.mail.EnviarCorreo;
...
public class CreateUser extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                cbCargo.setModel(new javax.swing.DefaultComboBoxModel<>(
                                new String[] { "Seleccionar", "Admin", "Empleado" }));
        ...
        private void enviarCorreoBienvenida() {
                String correo = ObtenerIU.obtenerTextoCampo(tfCorreo);
                String nombre = ObtenerIU.obtenerTextoCampo(tfNombre);
                String cargo = ObtenerIU.obtenerSeleccionCombo(cbCargo); // empleado, admin, cliente

                String asunto = "Bienvenido/a a Gym360 - Plataforma de Gestión Deportiva";
                final String mensaje;

                switch (cargo.toLowerCase()) {
                case "admin":
                        mensaje = "&#x1F451; ¡Hola, " + nombre + "!<br><br>"
                                        + "Tu cuenta de administrador en <strong>Gym360</strong> ha sido creada correctamente.<br><br>"
                                        + "Desde tu panel podrás gestionar usuarios, controlar el sistema y supervisar todas las operaciones del gimnasio.<br><br>"
                                        + "Si necesitas soporte técnico o tienes alguna duda, no dudes en contactarnos. &#128172;<br><br>"
                                        + "¡Gracias por liderar con nosotros!<br><br>" + "Atentamente,<br>"
                                        + "El equipo de Gym360. &#127947;&#65039;";
                        break;

                case "empleado":
                        mensaje = "&#128188; ¡Hola, " + nombre + "!<br><br>"
                                        + "Bienvenido/a a <strong>Gym360</strong>. Tu cuenta de empleado ha sido creada exitosamente.<br><br>"
                                        + "Ahora puedes comenzar a registrar asistencias, gestionar clases, atender clientes y más.<br><br>"
                                        + "Recuerda que cualquier inquietud puedes reportarla a soporte. &#128172;<br><br>"
                                        + "¡Gracias por formar parte del equipo!<br><br>" + "Atentamente,<br>"
                                        + "El equipo de Gym360. &#127947;&#65039;";
                        break;

                case "cliente":
                        mensaje = "&#127947; ¡Hola, " + nombre + "!<br><br>"
                                        + "¡Bienvenido/a a <strong>Gym360</strong>!<br><br>"
                                        + "Tu cuenta de cliente ha sido creada con éxito. A partir de ahora podrás acceder a tus rutinas, reservas de clases, pagos y mucho más desde nuestra plataforma.<br><br>"
                                        + "Si tienes alguna pregunta o necesitas ayuda, no dudes en escribirnos. &#128172;<br><br>"
                                        + "¡Nos alegra tenerte como parte de nuestra comunidad fitness!<br><br>"
                                        + "Atentamente,<br>" + "El equipo de Gym360. &#127947;&#65039;";
                        break;

                default:
                        mensaje = "&#128075; ¡Hola, " + nombre + "!<br><br>"
                                        + "Tu cuenta en <strong>Gym360</strong> ha sido creada.<br><br>"
                                        + "Si tienes preguntas o necesitas asistencia, estamos para ayudarte.<br><br>"
                                        + "Atentamente,<br>" + "El equipo de Gym360. &#127947;&#65039;";
                        break;
                }
