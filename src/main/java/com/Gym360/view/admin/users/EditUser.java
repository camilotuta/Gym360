...
public class EditUser extends javax.swing.JFrame {
        ...
        private void enviarCorreoActualizacion() {
                String correo = ObtenerIU.obtenerTextoCampo(tfCorreo);
                String nombre = ObtenerIU.obtenerTextoCampo(tfNombre);
                String cargo = ObtenerIU.obtenerSeleccionCombo(cbCargo); // admin, empleado, cliente

                String asunto = "Actualización de tus datos en Gym360";
                final String mensaje;

                switch (cargo.toLowerCase()) {
                case "admin":
                        mensaje = "&#x1F4DD; ¡Hola, " + nombre + "!<br><br>"
                                        + "Tus datos de administrador en <strong>Gym360</strong> han sido actualizados correctamente.<br><br>"
                                        + "Ahora podrás seguir gestionando usuarios, controlando el sistema y supervisando las operaciones del gimnasio con tus datos actualizados.<br><br>"
                                        + "Si tienes alguna consulta o necesitas asistencia adicional, estamos aquí para ayudarte. &#128172;<br><br>"
                                        + "¡Gracias por tu liderazgo!<br><br>" + "Atentamente,<br>"
                                        + "El equipo de Gym360. &#127947;&#65039;";
                        break;

                case "empleado":
                        mensaje = "&#128221; ¡Hola, " + nombre + "!<br><br>"
                                        + "Tus datos de empleado en <strong>Gym360</strong> han sido actualizados exitosamente.<br><br>"
                                        + "Ya puedes seguir registrando asistencias, gestionando clases y atendiendo clientes con tu información actualizada.<br><br>"
                                        + "Para cualquier duda o soporte, contáctanos sin problema. &#128172;<br><br>"
                ...
                case "cliente":
                        mensaje = "&#127775; ¡Hola, " + nombre + "!<br><br>"
                                        + "Tus datos de cliente en <strong>Gym360</strong> han sido actualizados con éxito.<br><br>"
                                        + "Ya puedes continuar accediendo a tus rutinas, reservas de clases y pagos con la información actualizada.<br><br>"
                                        + "Si necesitas ayuda o tienes alguna pregunta, no dudes en escribirnos. &#128172;<br><br>"
                                        + "¡Nos encanta tenerte en nuestra comunidad fitness!<br><br>"
                                        + "Atentamente,<br>" + "El equipo de Gym360. &#127947;&#65039;";
                        break;

                default:
                        mensaje = "&#128075; ¡Hola, " + nombre + "!<br><br>"
                                        + "Tus datos en <strong>Gym360</strong> han sido actualizados.<br><br>"
                                        + "Si tienes cualquier pregunta o requieres asistencia, estamos a tu disposición.<br><br>"
                                        + "Atentamente,<br>" + "El equipo de Gym360. &#127947;&#65039;";
                        break;
                }

                // Lanzamos el envío en un hilo separado para no bloquear la interfaz
                new Thread(() -> {
