...
public class ManageUsersScreen extends javax.swing.JFrame {
        ...
        public ManageUsersScreen() {
                ...
                CambiarIU.deshabilitarBotones(btnEditarUsuario, btnEliminarUsuario);
        }
        ...
        private void initComponents() {
                ...
                panelGestionUsuarios.add(lbUsuarios,
                ...
                panelGestionUsuarios.add(spTablaUsuarios,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 1230, 500));

                imgAgregarUsuario.setIcon(new javax.swing.ImageIcon(
                                getClass().getResource("/main/resources/images/agregarUsuario.png"))); // NOI18N
                panelGestionUsuarios.add(imgAgregarUsuario,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 690, -1, 60));
                ...
                panelGestionUsuarios.add(btnAgregarUsuario,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 690, 300, 60));

                imgEliminarUsuario.setIcon(new javax.swing.ImageIcon(
                                getClass().getResource("/main/resources/images/eliminar.png"))); // NOI18N
                panelGestionUsuarios.add(imgEliminarUsuario,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 690, 30, 60));
                ...
                panelGestionUsuarios.add(btnEliminarUsuario,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 690, 300, 60));

                imgEditarUsuario.setIcon(
                                new javax.swing.ImageIcon(getClass().getResource("/main/resources/images/editar.png"))); // NOI18N
                panelGestionUsuarios.add(imgEditarUsuario,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 690, 40, 60));
                ...
                panelGestionUsuarios.add(btnEditarUsuario,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 690, 300, 60));

                javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
                getContentPane().setLayout(layout);
                layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(panelGestionUsuarios, javax.swing.GroupLayout.DEFAULT_SIZE,
        ...
        private void tUsuariosMouseClicked(java.awt.event.MouseEvent evt) {
                int selectedRow = tUsuarios.getSelectedRow();

                idUsuarioSeleccionado = Integer.parseInt(tUsuarios.getValueAt(selectedRow, 0).toString());
                if (idUsuarioSeleccionado != -1) {
                        CambiarIU.habilitarBotones(btnEditarUsuario, btnEliminarUsuario);
                }
        }
        ...
        private void filtrarTablaUsuarios() {
                ...
                cargarTablaUsuarios(filtro); // Llamamos al método con el filtro actual
        }

        public void cargarTablaUsuarios(String filtro) {
                UsuarioDAO usuarioDAO = new UsuarioDAO();
                ...
                if (filtro == null || filtro.trim().isEmpty()) {
                        ...
                        usuarios = usuarioDAO.obtenerPorNombreUsuarioFiltro(filtro); // Puedes adaptar esto según cómo
                                                                                     // quieras aplicar
                        // el filtro
                }

                // Actualizado las columnas eliminando "ID Usuario" ya que ahora idEmpleado es
                // la PK
                String[] columnas = { "ID Empleado", "Nombre de Usuario", "Contraseña", "Cargo", "Correo" };
                DefaultTableModel model = new DefaultTableModel(columnas, 0);

                for (Usuario usuario : usuarios) {
                        // Removido usuario.getIdUsuario() ya que ese campo ya no existe
                        Object[] fila = { usuario.getIdEmpleado(), usuario.getNombreUsuario(), usuario.getContraseña(),
                                        usuario.getCargo(), usuario.getCorreo() };
                        model.addRow(fila);
                }

                tUsuarios.setModel(model); // Asegúrate de que esta tabla exista en tu clase
        }
