// cSpell:ignore rapidas simbolos
/*
...
public class DashboardEmployeeScreen extends javax.swing.JFrame {
        ...
        public DashboardEmployeeScreen() {
                ...
                this.setTitle("Dashboard Empleado");
        ...
        private void initComponents() {
                ...
                panelDashboard.add(lbDashboardEmpleado,
                ...
                pClientesActivos.add(lbPonerNumeroClientesActivos,
                ...
                pClientesActivos.add(lbClientesEnEstablecimiento,
                ...
                panelDashboard.add(pInventarioFaltante,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 430, 250, 110));
                ...
                panelDashboard.add(lbAccionesRapidas,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 280, 540, -1));

                imgRegistrarVenta.setIcon(new javax.swing.ImageIcon(
                                getClass().getResource("/main/resources/images/registrarVenta.png"))); // NOI18N
                panelDashboard.add(imgRegistrarVenta,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 350, 40, 80));
                ...
                panelDashboard.add(btnRegistrarVenta,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 350, 540, 80));

                imgRegistrarAsistencia.setIcon(new javax.swing.ImageIcon(
                                getClass().getResource("/main/resources/images/agregarUsuario.png"))); // NOI18N
                panelDashboard.add(imgRegistrarAsistencia,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 450, -1, 80));
                ...
                panelDashboard.add(btnRegistrarAsistencia,
                                new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 450, 540, 80));
        ...
        private void ponerClientesActivos() {
                ...
                CambiarIU.ponerTextoEtiqueta(lbPonerNumeroClientesActivos, String.valueOf(clientesActuales));

        }

        private void ponerVentas() {

                VentaDAO dao = new VentaDAO();
                List<Venta> registros = dao.obtenerTodos();

                double totalVentas = 0;

                for (Venta c : registros) {
                        if (c.getFecha().equals(Dates.obtenerFechaHoy())) {
                ...
                CambiarIU.ponerTextoEtiqueta(lbPonerIngresosDia, "$" + String.valueOf(formato.format(totalVentas)));
                CambiarIU.ponerTextoEtiqueta(lbMes, "En el día " + Dates.obtenerFechaHoy());
